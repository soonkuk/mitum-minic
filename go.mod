...
require (
	github.com/ProtoconNet/mitum-credential v0.0.0-20230810061724-ddcbb7556347
	github.com/ProtoconNet/mitum-currency/v3 v3.0.0-alpha.0.20230807133549-ef2acb2cd8c8
	github.com/ProtoconNet/mitum-nft/v2 v2.0.0-20230725080632-03ea70a25afe
	github.com/ProtoconNet/mitum-timestamp v0.0.0-20230808060642-8e6577cfe6e0
